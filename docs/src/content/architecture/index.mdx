...
See [State Management](/stores) for detailed store documentation.
...
**Tradeoff**: Not suitable for production multi-user apps. See [Database](../backend/database) for migration guide.
...
**For migration to database architecture, see [Database](/backend/database)**

**For deployment instructions, see [Deployment](/build-and-test/deployment)**
