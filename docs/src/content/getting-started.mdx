...
- **For production**: See [Backend & Database](/backend/database) for Supabase setup
...
See [Deployment](/build-and-test/deployment) for detailed deployment instructions.
...
1. [x] Update all content via admin dashboard
2. [x] Customize colors and theme
3. [x] Add your projects and skills
4. [x] Connect external blog (Medium RSS)

### Production Setup

1. Set up Supabase for database persistence - [Database](/backend/database)
2. Add authentication for admin panel
3. Deploy to Vercel - [Deployment](/build-and-test/deployment)
4. Set up analytics
